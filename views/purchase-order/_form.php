...
<div class="purchase-order-form">
    ...
    <div class="card">
        ...
        <div class="container-items card-body"> <!-- widgetContainer -->
    ...
    <?= $form->field($model, 'total_ppn')->widget(\yii\widgets\MaskedInput::class,
            [
                'clientOptions' => [
                    'alias' => 'numeric',
                    'groupSeparator' => ',',
    ...
    <?= $form->field($model, 'total_dpp')->widget(\yii\widgets\MaskedInput::class,
            [
                'clientOptions' => [
                    'alias' => 'numeric',
                    'groupSeparator' => ',',
